...
SOLID_FILL_COLOR_VAR_THRESHOLD = 25.0
...
def simple_fill_region(image_rgb: np.ndarray, region_mask: np.ndarray) -> tuple[np.ndarray, dict]:
    ...
    if len(xs) == 0:
        ...
        return cv2.cvtColor(inpaint, cv2.COLOR_BGR2RGB), {
            ...
            "simple_fill_branch": "empty_ring_fallback",
            "color_var": None,
            "solid_fill_threshold": SOLID_FILL_COLOR_VAR_THRESHOLD,
        }
    ...
    if color_var < SOLID_FILL_COLOR_VAR_THRESHOLD:
        ...
        return out, {
            "method": "solid_fill",
            "simple_fill_branch": "solid_fill_threshold",
            "color_var": color_var,
            "solid_fill_threshold": SOLID_FILL_COLOR_VAR_THRESHOLD,
        }
    ...
    return out, {
        "method": "opencv_telea",
        "simple_fill_branch": "telea_threshold",
        "color_var": color_var,
        "solid_fill_threshold": SOLID_FILL_COLOR_VAR_THRESHOLD,
    }